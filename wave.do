...
add wave -noupdate -radix unsigned /sync_fifo_tb/FIFO_DEPTH
add wave -noupdate -radix unsigned /sync_fifo_tb/DATA_WIDTH
add wave -noupdate -radix unsigned /sync_fifo_tb/WIDTH
...
add wave -noupdate -color Yellow /sync_fifo_tb/DUT/o_dataout
add wave -noupdate /sync_fifo_tb/DUT/i_valid_s
add wave -noupdate /sync_fifo_tb/DUT/i_datain
add wave -noupdate -radix unsigned /sync_fifo_tb/DUT/ptr
